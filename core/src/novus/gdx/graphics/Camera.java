...
public class Camera {
	...
	public Camera(novus.gdx.characters.Character character, float w, float h, Level world) {
		...
		float xc = character.getBoxX()*WORLD_TO_RENDER + w/2 - character.getWidth()*WORLD_TO_RENDER - 0.5f * WORLD_TO_RENDER;
		float yc = character.getBoxY()*WORLD_TO_RENDER + h/2 - character.getHeight()*WORLD_TO_RENDER - 0.5f * WORLD_TO_RENDER;
